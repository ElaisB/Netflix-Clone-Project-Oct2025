...
function RowList() {
  return (
    <>
        ...
        />
        <Row
            title="Document aries" fetchUrl={requests.fetchDocumentaries}
        />
        <Row
        ...
        />
        <Row
            title="Top Rated Movies" fetchUrl={requests.fetchTopRatedMovies}
        />
        <Row
            title="Tv Show" fetchUrl={requests.fetchTvShow}
        />
